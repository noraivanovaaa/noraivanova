...
function Consultations() {
  ...
  const items = [
  {
    ...
    d: "Индивидуална сесия с восък — работим с образи и символи, за да извадим на повърхността скритите модели и вътрешни конфликти."
  },
  {
    tag: "60 минути",
    t: "Консултация",
    d: "Разговор едно-към-едно — за ориентиране, яснота или конкретна тема, която те вълнува в момента."
  }];
  return (
