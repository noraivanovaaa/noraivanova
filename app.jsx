...
function Consultations() {
  const items = [
  {
    ...
    d: "Групови сесии с восък в различни градове. Всеки участник получава своя уникален образ и работим заедно върху смисъла му. Датите се обявяват предварително."
  },
  {
    tag: "Дистанционно",
    t: "Восъколеене",
    d: "Провеждаш ритуала при себе си с моето водене — онлайн, в реално време. Получаваш насоки как да работиш с образа и какво разкрива той за теб."
  },
  {
    tag: "60 минути",
    t: "Психологична консултация",
          ...
          <div className="lg:col-span-5">
            <Reveal delay={200}>
              <p className="text-[15px] leading-relaxed text-ink-soft max-w-md">
                Сесии едно-към-едно или на група — онлайн, дистанционно или на живо в различни градове.
              </p>
            </Reveal>
          </div>
        </div>
