...
function Consultations() {
  const items = [
  {
    tag: "Групова практика",
    t: "Восъкотерапия група",
    d: "Групови сесии с восък в различни градове. Всеки участник получава своя уникален образ и заедно работим върху смисъла му. Датите се обявяват предварително."
  },
  {
    tag: "Онлайн",
    t: "Восъкотерапия онлайн",
    d: "Индивидуална сесия с восък — провеждаш я при себе си с моето водене в реално време. Пълноценна терапевтична работа от всяка точка."
  },
  {
    tag: "Велико Търново",
    t: "Восъкотерапия в кабинет",
    d: "Присъствена индивидуална сесия в кабинет — Велико Търново. Работата на живо задълбочава процеса и дава пространство за по-цялостно преживяване."
  },
  {
    tag: "Дистанционно",
    t: "Восъколеене",
    d: "Провеждаш ритуала при себе си, аз те водя онлайн в реално време. Получаваш насоки как да работиш с образа и какво разкрива той за теб."
  },
  {
    tag: "60 минути",
    t: "Психологическа консултация",
    d: "Индивидуален разговор с мен като психолог — за ориентиране, яснота или конкретна тема, с която се носиш в момента."
  }];
