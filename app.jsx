...
function Consultations() {
  ...
  {
    tag: "90–120 минути",
    t: "Онлайн восъкотерапия",
    d: "Индивидуална сесия с восък онлайн — работим с образи и символи, за да осъзнаеш вътрешните модели и да намериш посока напред."
  },
  {
    tag: "90–120 минути",
    t: "Восъкотерапия в кабинет",
    d: "Присъствена сесия в кабинет — Велико Търново. Работата на живо задълбочава процеса и дава пространство за по-цялостно преживяване."
  },
  {
    tag: "Групово събитие",
    t: "Восъколеене",
    d: "Групова практика с восък — уникално преживяване, в което всеки получава своя образ и послание. Провежда се в различни градове."
  }];
          ...
          <div className="lg:col-span-5">
            <Reveal delay={200}>
              <p className="text-[15px] leading-relaxed text-ink-soft max-w-md">
                Сесии едно-към-едно, онлайн или на живо в Велико Търново. Всяка среща е поверителна и адаптирана към момента, в който се намираш.
              </p>
            </Reveal>
          </div>
        </div>
