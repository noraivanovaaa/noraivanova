...
function Program() {
  ...
  { icon: <Icon.Spark className="h-5 w-5" />, t: "Живи групови сесии", d: "Онлайн срещи в кръг, 60–90 минути, всяка седмица." },
  { icon: <Icon.Leaf className="h-5 w-5" />, t: "Практики", d: "Записани практики за работа с цикъла, луната и намерението." },
              ...
              <Reveal>
                <div className="rounded-3xl bg-lavender-soft p-7 h-full">
                  ...
                  <ul className="mt-5 space-y-3 text-[14px] leading-relaxed text-ink">
                    <li className="flex gap-3"><Icon.Plus className="h-4 w-4 mt-1 shrink-0" /> Готови за промяна в живота си</li>
                    <li className="flex gap-3"><Icon.Plus className="h-4 w-4 mt-1 shrink-0" /> Искат да привлекат повече изобилие и пари</li>
                    <li className="flex gap-3"><Icon.Plus className="h-4 w-4 mt-1 shrink-0" /> Отворени за промяна</li>
                    <li className="flex gap-3"><Icon.Plus className="h-4 w-4 mt-1 shrink-0" /> Търсещи възможности</li>
                  </ul>
                </div>
              </Reveal>
              <Reveal delay={120}>
                <div className="rounded-3xl bg-peach-soft p-7 h-full">
                  ...
                  <ul className="mt-5 space-y-3 text-[14px] leading-relaxed text-ink">
                    <li className="flex gap-3"><Icon.Plus className="h-4 w-4 mt-1 shrink-0" /> Осъзнаваш къде сам се саботираш</li>
                    <li className="flex gap-3"><Icon.Plus className="h-4 w-4 mt-1 shrink-0" /> Конкретни стъпки в живота и работата</li>
                    <li className="flex gap-3"><Icon.Plus className="h-4 w-4 mt-1 shrink-0" /> Практики, които остават с теб</li>
                  </ul>
                </div>
              </Reveal>
            </div>
...
function Testimonials() {
  ...
  { q: "Гледах образа и изведнъж всичко щракна. Нора само ме насочи — аз сама го видях.", n: "Калина Р.", c: "Восъкотерапия" },
  { q: "Очаквах ритуал, получих терапия. Асоциативното писане след леенето ме изненада — изкара неща, за които не знаех, че ги нося.", n: "Стела В.", c: "Восъкотерапия" },
  { q: "Не очаквах да се разплача, но беше освобождаващо. Едно от най-честните преживявания с себе си.", n: "Мария Д.", c: "Восъкотерапия" }];
...
function FAQ() {
  const items = [
  { q: "Какво представлява восъкотерапията?", a: "Восъкотерапията е терапевтична практика, която съчетава древен тракийски ритуал с принципи на съвременната психология. Работи с образи и символи — восъкът разкрива вътрешни модели и конфликти, които трудно се достигат само с думи." },
  { q: "Колко време продължава сесията?", a: "Индивидуалната сесия е 90–120 минути. Груповите формати варират в зависимост от броя участници." },
  { q: "Трябва ли да имам опит с подобни практики?", a: "Не. Идваш такава, каквато си. Нямаш нужда от предишен опит с терапия, ритуали или духовни практики." },
  { q: "Какво да очаквам след сесията?", a: "Повечето жени споделят усещане за яснота и лекота. Понякога процесът продължава и след сесията — образите и асоциациите продължават да работят." },
  { q: "Провежда ли се онлайн?", a: "Да. Восъкотерапията може да се проведе онлайн, дистанционно или на живо в кабинет — Велико Търново. Груповите сесии се провеждат в различни градове." },
  { q: "Как да запиша час?", a: "Пишете ми в Instagram — разказвате ми накратко за себе си и заедно избираме подходящия формат." }];
